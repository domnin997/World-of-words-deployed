...
function AppAbout () {
    ...
    return ( 
        <div className='about_block'>
            ...
            <AppAboutItem 
                pic={filterPic} 
                text={'Работать со словарем легко благодаря ряду фильтров - сортируйте слова по дате добавления и категории. '}> </AppAboutItem>
            <AppAboutItem 
                pic={freePic}
            ...
            <AppAboutItem
                pic={categoryPic}
                text={'Устанавливаейте приоритет для изучения и интервалы повторения, чтобы ускорить процесс.'}> </AppAboutItem>
        </div>
    ); 
}
